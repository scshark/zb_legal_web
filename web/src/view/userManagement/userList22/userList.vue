<template>
    <div>
        <div class="search-term">
            <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
                <el-form-item label="用户id">
                    <el-input placeholder="用户id" v-model="searchInfo.path"></el-input>
                </el-form-item>
                <el-form-item label="手机号">
                    <el-input placeholder="手机号" v-model="searchInfo.description"></el-input>
                </el-form-item>
                <el-form-item label="昵称">
                    <el-input placeholder="昵称" v-model="searchInfo.apiGroup"></el-input>
                </el-form-item>
                <el-form-item label="用户标签">
                    <el-select clearable placeholder="请选择用户标签" v-model="searchInfo.method">
                        <el-option
                        :key="item.value"
        ...
        <el-table :data="tableData" border stripe>
            ...
            <el-table-column label="区域" min-width="150" prop="area"></el-table-column>
            <el-table-column label="注册日期" min-width="150" prop="regTime"></el-table-column>
            <el-table-column label="标签" min-width="150" prop="userLabel"></el-table-column>
