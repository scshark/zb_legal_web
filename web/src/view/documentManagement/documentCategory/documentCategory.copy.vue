  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">        
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增文书分类</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="分类名称" prop="title" width="120"></el-table-column> 
    ...
    <el-table-column label="排序" prop="sort" width="120"></el-table-column> 
      ...
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button @click="updateDocumentCategory(scope.row)" size="small" type="primary">变更</el-button>
  ...
  data() {
    return {
      ...
      multipleSelection: [],formData: {
        title:'测试分类',parentId:0,hidden:0,sort:0,
      }
    };
  },
  filters: {
